...
@Component({
  selector: 'app-image-prompt-api',
  templateUrl: './image-prompt-api.component.html',
  standalone: false,
  styleUrl: './image-prompt-api.component.scss'
})
export class ImagePromptApiComponent extends BaseBuiltInApiPageComponent implements OnInit {
